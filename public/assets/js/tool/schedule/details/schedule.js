        ...
        SchedulePlan.prototype.openModal = function (event) {
            ...
            if (href != "" || fileName != "") {
                ...
                this.modalBody.find(".event-total-file").html(function () {
                    ...
                    var result =
                        '<input type="hidden" name="path"><input type="hidden" name="file"><input type="hidden" name="path"><div class="main-file"><div class="file-content"><div class="file-name">' +
                        fileName +
                        '</div><div class="file-action"><a href="https://drive.google.com/file/d/' +
                        href +
                        '/view"target="_blank" class="download-file"><i class="far fa-eye"></i></a><button class="delete-file del-total-file" type="button" onclick="deleteFileTotal(' +
                        fileName +
                        ", " +
                        href +
                        ", " +
