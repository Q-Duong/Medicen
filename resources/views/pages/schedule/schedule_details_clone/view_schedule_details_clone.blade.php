        ...
        <div class="row justify-content-end">
            <div class="col-lg-3 col-6">
                <div class="cd-intro-month">
                    ...
                    <select id="schedule-label" class="form-control select-year-details-clone"> 
                        @for($i=0;$i<=10;$i++) 
                            <option {{ $currentYear == $i+2023 ? 'selected' : '' }} value="{{$i+2023}}">{{$i+2023}}</option>
                        @endfor
                    </select>
                </div>
            </div>
            <div class="col-lg-3 col-6">
                <div class="cd-intro-month">
                    ...
                    <select id="schedule-label" class="form-control select-month-details-clone"> 
                        <option disabled class="define-month-details-clone">Chọn tháng</option>
                        @foreach($month as $key => $mth) 
                            <option {{ $month[$key] == $currentMonth ? 'selected' : '' }} value="{{$month[$key]}}">{{$key+1}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    var url_select_month_details_clone = "{{ route('select_month_details_clone') }}";
    var url_update_order_schedule = "{{ route('update_order_schedule',':id') }}";
</script>
