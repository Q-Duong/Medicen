        ...
        <div class="body">
            <div class="event-info">
                ...
                <p class="event-item">
                    ...
                    <span class="event-accountant-35X43"></span>
                </p>
                <p class="event-item">
                    <span class="item-title">Polime: </span>
                    <span class="event-accountant-polime"></span>
                </p>
                <p class="event-item">
                    <span class="item-title">8 X 10: </span>
                    <span class="event-accountant-8X10"></span>
                </p>
                <p class="event-item">
                    <span class="item-title">10 X 12: </span>
                    <span class="event-accountant-10X12"></span>
                </p>
                <p class="event-item">
                    <span class="item-title">Ghi chú báo cáo (Bộ phận kết quả): </span>
                    <span class="event-accountant-note"></span>
                </p>
                <p class="event-item">
                    <span class="item-title">Ngày trả kết quả: </span>
                    <span class="event-ord-delivery-date"></span>
                </p>
                <p class="event-item">
...
<div class="accountant">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="account-content">
                    <span class="account-title">Tổng số Cas nhũ ảnh: </span>
                    <span class="account-content-child">{{ $statistic_mammogram }}</span>
                </div>
            </div>
        </div>
    </div>
