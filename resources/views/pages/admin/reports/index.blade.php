                            ...
                            <div class="summary-box">
                                <table class="table-thu">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td
                                                style="font-style: italic; font-size: 14px; font-weight: bold; color: #3498db;">
                                                - Tổng nợ X-Quang</td>
                                            <td colspan="3"
                                        ...
                                        <tr>
                                            <td
                                                style="font-style: italic; font-size: 14px; font-weight: bold; color: #e67e22;">
                                                - Tổng đã xuất HD</td>
                                            <td colspan="3"
                                        ...
                                        <tr>
                                            <td
                                                style="font-style: italic; font-size: 14px; font-weight: bold; color: #c0392b;">
                                ...
                                @foreach ($orderedItems as $index => $item)
                                    ...
                                    @if ($currentMainGroup !== $main)
                                        <tr class="group-header" data-main-header="{{ $main }}">
                                            ...
                                            @if (!$sub && Auth::user()->role == 3 && (!isset($isYearly) || !$isYearly))
                                    ...
                                    <tr class="item-row" data-group="{{ $item->summary_group }}"
                                        data-type="{{ $item->type }}" data-main-group="{{ $main }}"
                                        style="{{ $rowBgColor }}">
                                        ...
                                        <td style="padding-left: {{ $sub ? '35px' : '15px' }}; text-align: left;">
                                            <input type="text" class="item-name"
                                                name="items[{{ $index }}][name]" value="{{ $item->name }}"
                                                style="width: 100%; border: none; font-weight: bold; background: transparent; outline: none; padding: 4px; font-size: 15px;"
                                                {{ (isset($isYearly) && $isYearly) || Auth::user()->role != 3 ? 'readonly' : '' }}>
                                        </td>
