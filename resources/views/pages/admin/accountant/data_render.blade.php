    ...
    <tr class="{{ $class }} {{ $accountant->status_id == 3 ? 'row-locked' : '' }}"
        ...
        <td>
            <input type="date" name="accountant_date"
                class="textbox-accountant  width-accountant-day accountant_date input-accountant"
        ...
        <td>
            <input type="date" name="accountant_discount_day"
                class="textbox-accountant  width-accountant-day accountant_discount_day input-accountant"
        ...
        <td>
            <input type="date" name="accountant_doctor_date_payment"
                class="textbox-accountant  width-accountant-day accountant_doctor_date_payment input-accountant"
