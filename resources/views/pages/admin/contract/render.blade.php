            ...
            @foreach ($getAllContract as $key => $accountant)
                <tr>
                    <form class="updateAccountant_">
                        ...
                        <td>
                            <select class="selectbox-accountant select-update contract_type_{{ $accountant->id }}"
                                ...
                                <option {{ $accountant->contract_type == null ? 'selected' : '' }}>
                                    Trống</option>
                                <option value="Nghiệm thu"
                                    {{ $accountant->contract_type == 'Nghiệm thu' ? 'selected' : '' }}>
                                    Nghiệm thu</option>
                                <option value="Thanh lý"
                                    {{ $accountant->contract_type == 'Thanh lý' ? 'selected' : '' }}>Thanh lý
                                </option>
                        ...
                        <td>
                            <select class="selectbox-accountant select-update contract_status contract-status-{{ $accountant->contract_status}} contract_status_{{ $accountant->id }}"
