                ...
                <div class="position-center">
                    <form action="{{route('update-post',$post->post_id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('post_title') ? 'has-error' : ''}}">
                            ...
                            <input type="text" name="post_title" class="input-control" placeholder="Điền tên bài viết" id="slug" onkeyup="ChangeToSlug();" value="{{$post->post_title}}">
                        ...
                        <div class="form-group {{ $errors->has('post_slug') ? 'has-error' : ''}}">
                            ...
                            <input type="text" name="post_slug" class="input-control" placeholder="Điền Slug bài viết"
                                id="convert_slug" value="{{$post->post_slug}}" readonly>
                        ...
                        <div class="form-group {{ $errors->has('post_content') ? 'has-error' : ''}}">
                            ...
                            <textarea name="post_content" rows=8 class="textarea-control" id="editor"
                                placeholder="Điền nội dung bài viết">{{$post->post_content}}
                            </textarea>
